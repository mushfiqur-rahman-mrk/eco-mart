        ...
        <div className="grid grid-cols-4 gap-4 my-16">
          ...
          >
            ...
            <div className="flex justify-between items-center   w-full px-5">
              <div>
                <h2 className="text-text font-normal text-base">Green Apple</h2>
                <p>$14.99</p>
                rating
              </div>
          ...
          >
            {isIconVisible && (
              <div className="border-[#CCCCCC] border-2 absolute right-3 top-3  rounded-full p-1.5 w-10 h-10 mr-3 ">
                <FavoriteBorderIcon
                  sx={{ color: "#1A1A1A", "&:hover": { color: "#00B207" } }}
                ></FavoriteBorderIcon>
              </div>
